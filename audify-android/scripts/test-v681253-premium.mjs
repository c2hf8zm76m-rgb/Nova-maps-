...
assert.match(premium, /Sans publicités ajoutées par Audify/);
assert.match(premium, /Supprime les publicités propres à l’interface Audify\./);
assert.match(premium, /Audify Premium ne remplace pas YouTube Premium\./);
assert.ok(!premium.includes('Zéro publicité'));
